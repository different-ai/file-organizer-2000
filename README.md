...
This is an Obsidian Plugin that uses AI to help you keep your files organized. It tags, renames, and moves files to the most appropriate folders in your vault. Also allows you to transcribe audios, process images for annotations, or to create AI templates
