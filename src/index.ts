...
const POPULAR_OBSIDIAN_TAGS = [
  ...
  "#problem", "#solution", "#improvement", "#growth", "#career", "#family",
  "#technology", "#science", "#art", "#music", "#literature", "#philosophy",
  "#history", "#politics", "#economics", "#psychology", "#sociology", "#anthropology",
  "#biology", "#physics", "#chemistry", "#mathematics", "#coding", "#programming",
  "#design", "#writing", "#reading", "#learning", "#teaching", "#mentoring",
  "#leadership", "#management", "#entrepreneurship", "#startup", "#innovation",
  "#sustainability", "#environment", "#climate", "#energy", "#space", "#astronomy",
  "#geology", "#geography", "#language", "#culture", "#religion", "#spirituality",
  "#mindfulness", "#wellness", "#fitness", "#nutrition", "#sleep", "#stress",
  "#anxiety", "#depression", "#mentalhealth", "#physicalhealth", "#medicine",
  "#healthcare", "#selfcare", "#selfimprovement", "#personaldevelopment",
  "#relationships", "#communication", "#networking", "#collaboration", "#teamwork",
  "#conflict", "#negotiation", "#timemanagement", "#organization", "#declutter",
  "#minimalism", "#budgeting", "#investing", "#saving", "#debt", "#retirement",
  "#insurance", "#taxes", "#realestate", "#business", "#marketing", "#sales",
  "#customerservice", "#branding", "#socialmedia", "#digitalmarketing", "#ecommerce",
  "#freelance", "#remotework", "#office", "#workplace", "#interview", "#resume",
  "#skills", "#training", "#certification", "#degree", "#course", "#workshop",
  "#seminar", "#conference", "#webinar", "#podcast", "#video", "#blog", "#ebook",
  "#whitepaper", "#casestudy", "#research", "#data", "#analytics", "#statistics",
  "#ai", "#machinelearning", "#deeplearning", "#neuralnetworks", "#blockchain",
  "#cryptocurrency", "#bitcoin", "#ethereum", "#cybersecurity", "#privacy",
  "#ethics", "#law", "#regulation", "#compliance", "#governance", "#risk",
  "#audit", "#quality", "#safety", "#environment", "#sustainability", "#csr",
  "#diversity", "#inclusion", "#equality", "#humanrights", "#socialimpact",
  "#volunteering", "#charity", "#nonprofit", "#philanthropy", "#activism",
  "#advocacy", "#policy", "#government", "#democracy", "#election", "#voting",
  "#citizenship", "#immigration", "#globalization", "#internationaltrade",
  "#foreignpolicy", "#diplomacy", "#war", "#peace", "#conflict", "#security",
  "#defense", "#military", "#intelligence", "#terrorism", "#crime", "#justice",
  "#lawenforcement", "#prison", "#rehabilitation", "#addiction", "#recovery",
  "#mentalillness", "#disability", "#accessibility", "#inclusion", "#ageism",
  "#retirement", "#aging", "#longevity", "#death", "#grief", "#loss", "#trauma",
  "#resilience", "#coping", "#stress", "#relaxation", "#mindfulness", "#yoga",
  "#pilates", "#martialarts", "#sports", "#athletics", "#olympics", "#competition",
  "#coaching", "#teambuilding", "#leadership", "#influence", "#persuasion",
  "#negotiation", "#sales", "#marketing", "#advertising", "#pr", "#media",
  "#journalism", "#fakenews", "#misinformation", "#factchecking", "#truthseeking",
  "#criticalthinking", "#logic", "#reasoning", "#debate", "#argument", "#rhetoric",
  "#writing", "#editing", "#publishing", "#storytelling", "#fiction", "#nonfiction",
  "#poetry", "#drama", "#screenplay", "#filmmaking", "#photography", "#painting",
  "#sculpture", "#dance", "#theater", "#opera", "#classicalmusic", "#jazz",
  "#rock", "#hiphop", "#electronic", "#worldmusic", "#musictheory", "#composition",
  "#performance", "#concert", "#festival", "#exhibition", "#museum", "#gallery",
  "#auction", "#collecting", "#antiquities", "#archaeology", "#paleontology",
  "#evolution", "#genetics", "#neuroscience", "#cognition", "#consciousness",
  "#perception", "#memory", "#learning", "#intelligence", "#creativity",
  "#innovation", "#invention", "#patent", "#intellectualproperty", "#copyright",
  "#trademark", "#licensing", "#franchising", "#merger", "#acquisition",
  "#ipo", "#stockmarket", "#commodities", "#forex", "#options", "#futures",
  "#hedgefund", "#privateequity", "#venturecapital", "#angelinvesting",
  "#crowdfunding", "#microlending", "#banking", "#fintech", "#insurtech",
  "#regtech", "#legaltech", "#healthtech", "#edtech", "#cleantech", "#greentech",
  "#biotech", "#nanotech", "#quantum", "#robotics", "#drones", "#3dprinting",
  "#augmentedreality", "#virtualreality", "#mixedreality", "#wearables",
  "#iot", "#smartcity", "#smartgrid", "#renewableenergy", "#solarpower",
  "#windpower", "#hydropower", "#geothermal", "#nuclearenergy", "#fossilfuels",
  "#climatechange", "#globalwarming", "#carbonemissions", "#deforestation",
  "#biodiversity", "#conservation", "#recycling", "#zerowaste", "#circulareconomy",
  "#sustainablefashion", "#slowfashion", "#ethicalfashion", "#veganfashion",
  "#organicfood", "#locavore", "#farmtotable", "#slowfood", "#veganism",
  "#vegetarianism", "#plantbased", "#glutenfree", "#dairyfree", "#keto",
  "#paleo", "#intermittentfasting", "#weightloss", "#bodypositive", "#beauty",
  "#skincare", "#haircare", "#makeup", "#fragrance", "#fashion", "#style",
  "#luxury", "#vintage", "#secondhand", "#upcycling", "#diy", "#crafts",
  "#knitting", "#crochet", "#sewing", "#woodworking", "#metalworking",
  "#pottery", "#glassblowing", "#jewelry", "#leathercraft", "#papercraft",
  "#origami", "#calligraphy", "#handlettering", "#graphicdesign", "#typography",
  "#logodesign", "#branding", "#packaging", "#industrialdesign", "#architecture",
  "#interiordesign", "#landscapedesign", "#urbanplanning", "#construction",
  "#renovation", "#homeimprovement", "#gardening", "#permaculture", "#hydroponics",
  "#aquaponics", "#farming", "#agriculture", "#horticulture", "#viticulture",
  "#brewing", "#distilling", "#mixology", "#coffee", "#tea", "#chocolate",
  "#cheese", "#wine", "#beer", "#spirits", "#cocktails", "#baking", "#grilling",
  "#smoking", "#fermentation", "#preservation", "#canning", "#foraging",
  "#wildcrafting", "#herbalism", "#aromatherapy", "#essentialoils", "#massage",
  "#acupuncture", "#chiropractic", "#osteopathy", "#physiotherapy", "#occupationaltherapy",
  "#speechtherapy", "#cognitivebehavioraltherapy", "#psychotherapy", "#counseling",
  "#coaching", "#mentoring", "#tutoring", "#homeschooling", "#onlinelearning",
  "#mooc", "#languagelearning", "#bilingualism", "#multilingualism", "#translation",
  "#interpretation", "#linguistics", "#grammar", "#vocabulary", "#etymology",
  "#semantics", "#syntax", "#phonetics", "#phonology", "#morphology", "#pragmatics",
  "#discourse", "#rhetoric", "#oratory", "#publicspeaking", "#presentation",
  "#facilitation", "#moderation", "#mediation", "#arbitration", "#diplomacy",
  "#negotiation", "#conflictresolution", "#peacebuilding", "#reconciliation",
  "#forgiveness", "#empathy", "#compassion", "#kindness", "#gratitude",
  "#happiness", "#wellbeing", "#flourishing", "#positivepsychology", "#mindset",
  "#growthmindset", "#grit", "#resilience", "#perseverance", "#determination",
  "#willpower", "#selfcontrol", "#discipline", "#habit", "#routine", "#ritual",
  "#tradition", "#culture", "#heritage", "#folklore", "#mythology", "#legend",
  "#fairytale", "#fable", "#parable", "#allegory", "#symbolism", "#metaphor",
  "#analogy", "#idiom", "#proverb", "#quote", "#aphorism", "#wisdom", "#philosophy",
  "#ethics", "#morality", "#virtue", "#vice", "#good", "#evil", "#right", "#wrong",
  "#justice", "#fairness", "#equality", "#liberty", "#freedom", "#democracy",
  "#autocracy", "#oligarchy", "#plutocracy", "#meritocracy", "#technocracy",
  "#bureaucracy", "#anarchy", "#socialism", "#communism", "#capitalism",
  "#freemarket", "#mixedeconomy", "#welfare", "#socialsecurity", "#healthcare",
  "#education", "#housing", "#transportation", "#infrastructure", "#energy",
  "#water", "#food", "#agriculture", "#industry", "#manufacturing", "#service",
  "#retail", "#hospitality", "#tourism", "#entertainment", "#media", "#arts",
  "#culture", "#sports", "#recreation", "#leisure", "#hobby", "#game", "#puzzle",
  "#riddle", "#mystery", "#thriller", "#horror", "#fantasy", "#scifi", "#romance",
  "#adventure", "#comedy", "#drama", "#tragedy", "#satire", "#parody", "#humor"
];
