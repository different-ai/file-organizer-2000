            ...
            <div className="text-center flex flex-col justify-center items-center">
              {billingCycle === "lifetime" && (
                <div className="mb-6 text-left">
                  <h2 className="text-2xl font-bold mb-4">Setup Instructions for Lifetime Users:</h2>
                  <ol className="list-decimal list-inside space-y-2">
                  <li>
        Deploy your own instance:
        <a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fdifferent-ai%2Ffile-organizer-2000%2Ftree%2Fmaster%2Fapp&env=OPENAI_API_KEY,SOLO_API_KEY&envDescription=SOLO_API_KEY%20is%20a%20bit%20like%20your%20password%20you%20can%20choose%20it%20to%20be%20whatever%20you%20want%20and%20you%27ll%20need%20to%20re-use%20in%20the%20plugin%20settings&envLink=https%3A%2F%2Fgithub.com%2Fdifferent-ai%2Ffile-organizer-2000%2Fblob%2Fmaster%2Ftutorials%2Fenv-vars.md&project-name=file-organizer-2000&repository-name=file-organizer-2000&redirect-url=https%3A%2F%2Fgithub.com%2Fdifferent-ai%2Ffile-organizer-2000%2Fblob%2Fmaster%2Ftutorials%2Fdeploy-on-vercel-success.md&build-command=npm%20run%20build:self-host" target="_blank" rel="noopener noreferrer">
          <img src="https://vercel.com/button" alt="Deploy with Vercel" className="ml-2 inline-block" />
        </a>
        <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
          <li>During deployment, you'll need to enter your OpenAI API Key. You can create one <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">here</a>.</li>
          <li>For the SOLO_API_KEY, use the license key generated below on this page.</li>
        </ul>
      </li>
                    <li>
