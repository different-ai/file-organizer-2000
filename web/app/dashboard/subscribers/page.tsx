...
export default function SubscribersDashboard() {
  if (process.env.ENABLE_USER_MANAGEMENT !== "true") {
    return <div className="p-4 border-4 border-black text-center font-mono text-xl">User management is disabled</div>;
  }
  return (
    <div className="min-h-screen p-4 bg-white font-mono">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 border-b-4 border-black pb-2 uppercase">Subscriber Dashboard</h1>
          ...
          <div className="border-4 border-black p-4">
            ...
            <div className="text-center p-4">
              ...
              <a href="obsidian://show-plugin?id=fileorganizer2000">
                <Button className="w-full bg-black text-white hover:bg-gray-800 uppercase">Download</Button>
              </a>
