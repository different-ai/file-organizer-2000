...
Vault Access in Note Companion refers to the plugin’s ability to manage and organize files within specific folders or paths in your Obsidian vault. By configuring Vault Access settings, you can specify which folders the plugin should monitor and organize. This allows you to control exactly where the File Organizer operates, ensuring it only affects the parts of your vault that you want it to.
